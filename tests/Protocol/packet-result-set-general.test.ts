...
const tests: Test[] = [
  ...
  ["BINARY(10)", { type: FieldTypes.CHAR }, "'exa\0ple'", "exa\0ple\0\0\0"],
  ["VARBINARY(10)", { type: FieldTypes.VARCHAR }, "'exa\0ple'", "exa\0ple"],
  [
    "TINYBLOB",
    { type: FieldTypes.BLOB },
    "'exa\0ple'",
    Buffer.from("exa\0ple"),
  ],
  ["BLOB", { type: FieldTypes.BLOB }, "'exa\0ple'", Buffer.from("exa\0ple")],
  [
    "MEDIUMBLOB",
    { type: FieldTypes.BLOB },
    "'exa\0ple'",
